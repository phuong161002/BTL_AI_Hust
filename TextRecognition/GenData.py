...
trainingImgPath = 'F:\\Python\\Car_Plate_Recognition\\BTL_AI_Hust\\Image\\Chars\\training_chars.png'

###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread(trainingImgPath)            # read in training numbers image
    ...
    cv2.imshow('img', imgTrainingNumbers)
